...
class LicenseController extends Controller
{
	...
	public function activate_license($license, $client, $create_lic = true){
		return array('status' => TRUE, 'message' => base64_decode('TGljZW5zZSB2ZXJpZmllZC4gQnkgRG9uaWFXZUIuY29t'));
	}
	...
	public function prompt($time_based_check = false, $license = false, $client = false){
		return array('status' => TRUE, 'message' => 'Verified! Thanks for purchasing.');
	}
